...
const subtypeGroups = [
  {
    ...
    items: [
      ...
      { category: 'official', subtype: 'head-of-state',        emoji: '🏛️', label: 'Head of State',       shape: 'circle' },
      { category: 'official', subtype: 'independent-official', emoji: '👤', label: 'Independent Official', shape: 'circle' },
  ...
  },
  {
    heading: 'Departments',
    items: [
      { category: 'department', subtype: 'ministerial', emoji: '🏛️', label: 'Ministry',                    shape: 'square' },
      { category: 'department', subtype: 'agency',      emoji: '⚙️', label: 'Government Office',           shape: 'rounded-square' },
      { category: 'department', subtype: 'portfolio',   emoji: '📁', label: 'Portfolio (no own ministry)', shape: 'square' },
    ],
  },
  {
    heading: 'Bodies',
    items: [
      { category: 'body', subtype: 'constitutional-body',  emoji: '⚖️', label: 'Constitutional Body',  shape: 'diamond' },
      { category: 'body', subtype: 'executive-agency',     emoji: '📋', label: 'Executive Agency',      shape: 'diamond' },
      { category: 'body', subtype: 'regulator',            emoji: '🔍', label: 'Regulator',             shape: 'diamond' },
      { category: 'body', subtype: 'public-law-body',      emoji: '🏢', label: 'Public Law Body',       shape: 'diamond' },
      { category: 'body', subtype: 'security-agency',      emoji: '🛡️', label: 'Security Agency',       shape: 'diamond' },
      { category: 'body', subtype: 'military',             emoji: '⚔️', label: 'Military',              shape: 'diamond' },
      { category: 'body', subtype: 'public-corporation',   emoji: '🏢', label: 'Public Corporation',    shape: 'diamond' },
    ],
  },
  {
    heading: 'Groups',
