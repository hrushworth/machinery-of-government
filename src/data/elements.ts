...
export const tagDefinitions: Record<string, TagDefinition> = {
  ...
  'statutory-regulator':  { id: 'statutory-regulator',   label: 'Statutory Regulator',    tagCategory: 'type',   colour: '#c0392b' },
  'professional-regulator': { id: 'professional-regulator', label: 'Professional Regulator', tagCategory: 'type', colour: '#922b21' },
...
export interface GovElement {
  ...
  currentHolderSince?: string   // ISO date (YYYY-MM-DD) the current holder took office
  infoUrl?: string
  parentIds: string[]
...
export const govElements: Record<string, GovElement> = {
  ...
  'pm': {
    ...
    currentHolder: 'Andy Burnham',
    currentHolderSince: '2026-07-20',
  ...
  'cabinet-office-sec': {
    ...
    name: 'First Secretary of State, Chancellor of the Duchy of Lancaster',
    category: 'official',
    subtype: 'cabinet-minister',
    role: 'Cabinet Member',
    description: 'Minister for the Cabinet Office and Cabinet Secretary to the Prime Minister',
    currentHolder: 'Louise Haigh',
    currentHolderSince: '2026-07-20',
  ...
  'dbt-sec': {
    id: 'dbt-sec',
    name: 'Secretary of State for Business, Innovation, Science and Trade',
    category: 'official',
    subtype: 'cabinet-minister',
    role: 'Cabinet Member',
    description: 'Minister responsible for business, innovation, science, trade and industry',
    currentHolder: 'Jonathan Reynolds',
    currentHolderSince: '2026-07-20',
    infoUrl: 'https://www.gov.uk/government/ministers/secretary-of-state-for-business-and-trade',
    parentIds: ['pm', 'cabinet'],
  },
  'dcms-sec': {
    id: 'dcms-sec',
    name: 'Secretary of State for Digital, Culture, Media and Sport',
    category: 'official',
    subtype: 'cabinet-minister',
    role: 'Cabinet Member',
    description: 'Minister responsible for digital, media, sport and culture',
  ...
  'moj-sec': {
    ...
    subtype: 'cabinet-minister',
    role: 'Cabinet Member',
    description: 'Minister responsible for the justice system',
  ...
  'women-equalities-sec': {
    id: 'women-equalities-sec',
    name: 'Minister for Women and Equalities',
    category: 'official',
    subtype: 'cabinet-minister',
    role: 'Cabinet Member',
    description: 'Minister responsible for equality policy across government, reporting directly to the Prime Minister.',
    currentHolder: 'Bridget Phillipson',
    currentHolderSince: '2026-07-20',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-for-women-and-equalities',
    parentIds: ['pm', 'cabinet'],
  },
  'leader-commons-sec': {
    id: 'leader-commons-sec',
    name: 'Lord President of the Council and Leader of the House of Commons',
    category: 'official',
    subtype: 'cabinet-minister',
    role: 'Cabinet Member',
    description: 'Manages government business in the House of Commons and chairs the Privy Council.',
    currentHolder: 'Sir Alan Campbell',
    currentHolderSince: '2025-09-05',
    infoUrl: 'https://www.gov.uk/government/ministers/leader-of-the-house-of-commons',
    parentIds: ['pm', 'cabinet'],
  },
  'leader-lords-sec': {
    id: 'leader-lords-sec',
    name: 'Lord Privy Seal and Leader of the House of Lords',
    category: 'official',
    subtype: 'cabinet-minister',
    role: 'Cabinet Member',
    description: 'Manages government business in the House of Lords.',
    currentHolder: 'Baroness Smith of Basildon',
    currentHolderSince: '2024-07-05',
    infoUrl: 'https://www.gov.uk/government/ministers/leader-of-the-house-of-lords',
    parentIds: ['pm', 'cabinet'],
  },
  ...
  'treasury-fin-sec': {
    id: 'treasury-fin-sec',
    name: 'Financial Secretary to the Treasury and Paymaster General',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Financial Secretary to the Treasury and Paymaster General.',
    currentHolder: 'James Murray',
    infoUrl: 'https://www.gov.uk/government/ministers/financial-secretary-to-the-treasury',
    parentIds: ['pm', 'chancellor', 'cabinet-office-sec'],
  },
  ...
  'treasury-pus-1': {
    id: 'treasury-pus-1',
    name: 'Parliamentary Secretary (HM Treasury)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Secretary in HM Treasury.',
    currentHolder: 'Lord Pitt-Watson',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-secretary-hm-treasury',
    parentIds: ['pm', 'chancellor'],
  },
  'advocate-gen-scotland': {
    jurisdictions: ['scotland'],
    id: 'advocate-gen-scotland',
    name: 'HM Advocate General for Scotland',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Chief legal adviser to the UK Government on Scots law.',
    currentHolder: 'Baroness Smith of Cluny',
    infoUrl: 'https://www.gov.uk/government/ministers/advocate-general-for-scotland',
  ...
  'fcdo-middle-east': {
    id: 'fcdo-middle-east',
    name: 'Minister of State (Intergovernmental Relations and European Relations)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Intergovernmental Relations and European Relations), jointly in the Cabinet Office and the Foreign, Commonwealth and Development Office. Attends Cabinet.',
    ...
    parentIds: ['pm', 'fcdo-sec', 'cabinet-office-sec'],
  },
  'fcdo-multilateral': {
  ...
  'fcdo-minister-state-2': {
    id: 'fcdo-minister-state-2',
    name: 'Minister of State (FCDO)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Foreign, Commonwealth and Development Office.',
    currentHolder: 'Kirsty McNeill',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state-foreign-commonwealth-development-office--3',
    parentIds: ['pm', 'fcdo-sec'],
  },
  'fcdo-pus-1': {
    id: 'fcdo-pus-1',
    name: 'Parliamentary Under-Secretary (FCDO)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Foreign, Commonwealth and Development Office.',
    currentHolder: 'Uma Kumaran',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--foreign-commonwealth-development-office--4',
    parentIds: ['pm', 'fcdo-sec'],
  },
  'fcdo-pus-2': {
    id: 'fcdo-pus-2',
    ...
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Foreign, Commonwealth and Development Office.',
    currentHolder: 'Lord Wood of Anfield',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--foreign-commonwealth-development-office--5',
    parentIds: ['pm', 'fcdo-sec'],
  },
  'fcdo-pus-3': {
    id: 'fcdo-pus-3',
    ...
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Foreign, Commonwealth and Development Office.',
    currentHolder: 'Baroness Winterton of Doncaster',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--foreign-commonwealth-development-office--6',
    parentIds: ['pm', 'fcdo-sec'],
  },
  'home-security': {
    id: 'home-security',
    ...
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Security), jointly in the Home Office and the Cabinet Office.',
    currentHolder: 'Dan Jarvis',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--66',
    parentIds: ['pm', 'home-sec', 'cabinet-office-sec'],
  },
  'home-policing': {
    id: 'home-policing',
  ...
  'home-migration': {
    ...
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Home Office.',
    currentHolder: 'Lord Hanson of Flint',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--home-office--2',
    parentIds: ['pm', 'home-sec'],
  },
  'home-minister-state-2': {
    id: 'home-minister-state-2',
    name: 'Minister of State (Home Office)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Home Office.',
    currentHolder: 'Anna Turley',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--69',
    parentIds: ['pm', 'home-sec'],
  },
  'home-pus-2': {
    id: 'home-pus-2',
    name: 'Parliamentary Under-Secretary (Home Office)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Home Office.',
    currentHolder: 'Jo White',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--home-office--3',
    parentIds: ['pm', 'home-sec'],
  },
  'home-equalities-pus-1': {
    id: 'home-equalities-pus-1',
    name: 'Parliamentary Under-Secretary (Home Office and Equalities)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State, jointly in the Home Office and the Ministry of Housing, Communities and Local Government (Minister for Equalities).',
    currentHolder: 'Satvir Kaur',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--home-office--4',
    parentIds: ['pm', 'home-sec', 'dluhc-sec'],
  },
  'home-equalities-pus-2': {
    id: 'home-equalities-pus-2',
    name: 'Parliamentary Under-Secretary (Home Office and Equalities)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State, jointly in the Home Office and the Ministry of Housing, Communities and Local Government (Minister for Equalities). Remains Deputy Leader of the House of Lords.',
    currentHolder: 'Lord Collins of Highbury',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--home-office--5',
    parentIds: ['pm', 'home-sec', 'dluhc-sec'],
  },
  'mod-readiness': {
    id: 'mod-readiness',
  ...
  'mod-minister-state-2': {
    id: 'mod-minister-state-2',
    name: 'Minister of State (Ministry of Defence)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Ministry of Defence.',
    currentHolder: 'Lord Coaker',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--ministry-of-defence--2',
    parentIds: ['pm', 'defence-sec'],
  },
  'mod-pus-2': {
    id: 'mod-pus-2',
    name: 'Parliamentary Under-Secretary (Ministry of Defence)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Ministry of Defence.',
    currentHolder: 'Calvin Bailey',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--ministry-of-defence--3',
    parentIds: ['pm', 'defence-sec'],
  },
  'moj-courts': {
    id: 'moj-courts',
  ...
  'moj-minister-state-2': {
    id: 'moj-minister-state-2',
    name: 'Minister of State (Ministry of Justice)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Ministry of Justice.',
    currentHolder: 'Catherine McKinnell',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--ministry-of-justice--3',
    parentIds: ['pm', 'moj-sec'],
  },
  'moj-pus-2': {
    id: 'moj-pus-2',
    name: 'Parliamentary Under-Secretary (Ministry of Justice)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Ministry of Justice.',
    currentHolder: 'Lord Lemos',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--ministry-of-justice--3',
    parentIds: ['pm', 'moj-sec'],
  },
  'dluhc-housing': {
    id: 'dluhc-housing',
  ...
  'dluhc-local-gov-2': {
    id: 'dluhc-local-gov-2',
    name: 'Minister of State (Local Government)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Local Government).',
    currentHolder: 'Florence Eshalomi',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--56',
    parentIds: ['pm', 'dluhc-sec'],
  },
  'dluhc-equalities': {
    id: 'dluhc-equalities',
    name: 'Minister of State (Equalities)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Ministry of Housing, Communities and Local Government (Minister for Equalities). Remains Minister of State in the Department for Work and Pensions.',
    ...
    parentIds: ['pm', 'dluhc-sec', 'wpc-sec'],
  },
  'dluhc-pus-3': {
    id: 'dluhc-pus-3',
    name: 'Parliamentary Under-Secretary (MHCLG)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Ministry of Housing, Communities and Local Government.',
    currentHolder: 'Jim McMahon',
  ...
  'dluhc-pus-4': {
    ...
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Ministry of Housing, Communities and Local Government.',
    currentHolder: 'Baroness Blake of Leeds',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--ministry-of-housing-communities-and-local-government--3',
    parentIds: ['pm', 'dluhc-sec'],
  },
  'dluhc-pus-5': {
    id: 'dluhc-pus-5',
    ...
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Ministry of Housing, Communities and Local Government.',
    currentHolder: 'Baroness Taylor of Stevenage',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--ministry-of-housing-communities-and-local-government--4',
    parentIds: ['pm', 'dluhc-sec'],
  },
  'dluhc-equalities-2': {
    id: 'dluhc-equalities-2',
    name: 'Parliamentary Under-Secretary (Equalities)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Ministry of Housing, Communities and Local Government (Minister for Equalities). Remains Parliamentary Under-Secretary of State in the Department for Transport.',
    currentHolder: 'Simon Lightwood',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--ministry-of-housing-communities-and-local-government--5',
    parentIds: ['pm', 'dluhc-sec', 'transport-sec'],
  },
  'dhsc-secondary-care': {
  ...
  'dhsc-minister-state-3': {
    id: 'dhsc-minister-state-3',
    name: 'Minister of State (Department of Health and Social Care)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Department of Health and Social Care.',
    currentHolder: 'Dame Diana Johnson',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--department-of-health-and-social-care--3',
    parentIds: ['pm', 'dhsc-sec'],
  },
  'dhsc-minister-state-4': {
    id: 'dhsc-minister-state-4',
    name: 'Minister of State (Department of Health and Social Care)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Department of Health and Social Care.',
    currentHolder: 'Alison McGovern',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--department-of-health-and-social-care--4',
    parentIds: ['pm', 'dhsc-sec'],
  },
  'dhsc-minister-state-5': {
    id: 'dhsc-minister-state-5',
    name: 'Minister of State (Department of Health and Social Care)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Department of Health and Social Care. Remains Minister of State in the Department for Business, Innovation, Science and Trade.',
    currentHolder: 'Chris McDonald',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--department-of-health-and-social-care--5',
    parentIds: ['pm', 'dhsc-sec', 'dbt-sec'],
  },
  'dhsc-pus-2': {
    id: 'dhsc-pus-2',
    name: 'Parliamentary Under-Secretary (DHSC)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department of Health and Social Care.',
    currentHolder: 'James Frith',
  ...
  'dfe-skills': {
    ...
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Skills and Equalities), jointly in the Department for Work and Pensions and the Department for Education.',
    ...
    parentIds: ['pm', 'dfe-sec', 'wpc-sec'],
  },
  'dfe-pus-2': {
    id: 'dfe-pus-2',
    name: 'Parliamentary Under-Secretary (Department for Education)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Education.',
    currentHolder: 'Paul Waugh',
  ...
  'desnz-climate': {
    id: 'desnz-climate',
    name: 'Minister of State (Climate)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Climate).',
  ...
  'desnz-pus-3': {
    id: 'desnz-pus-3',
    name: 'Parliamentary Under-Secretary (DESNZ)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Energy Security and Net Zero.',
    currentHolder: 'Polly Billington',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-energy-security-and-net-zero--4',
    parentIds: ['pm', 'desnz-sec'],
  },
  'desnz-pus-4': {
    id: 'desnz-pus-4',
    ...
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Energy Security and Net Zero.',
    currentHolder: 'Baroness Curran',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-energy-security-and-net-zero--5',
    parentIds: ['pm', 'desnz-sec'],
  },
  'dwp-employment': {
    id: 'dwp-employment',
  ...
  'dwp-pensions': {
    id: 'dwp-pensions',
    name: 'Parliamentary Secretary (Pensions)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Secretary, jointly in HM Treasury and the Department for Work and Pensions.',
    ...
    parentIds: ['pm', 'wpc-sec', 'chancellor'],
  },
  'dwp-minister-state-2': {
    id: 'dwp-minister-state-2',
    name: 'Minister of State (Department for Work and Pensions)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Department for Work and Pensions.',
    currentHolder: 'Baroness Sherlock',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--department-for-work-and-pensions--2',
    parentIds: ['pm', 'wpc-sec'],
  },
  'dwp-pus-2': {
    id: 'dwp-pus-2',
    name: 'Parliamentary Under-Secretary (Department for Work and Pensions)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Work and Pensions.',
    currentHolder: 'Lilian Greenwood',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-work-and-pensions--3',
    parentIds: ['pm', 'wpc-sec'],
  },
  'dbt-trade': {
    id: 'dbt-trade',
  ...
  'dbt-small-biz': {
    ...
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State, jointly in the Department for Business, Innovation, Science and Trade and the Department for Energy Security and Net Zero.',
    ...
    parentIds: ['pm', 'dbt-sec', 'desnz-sec'],
  },
  'dbt-employment-rights': {
    id: 'dbt-employment-rights',
    name: 'Minister of State (Employment Rights)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Employment Rights).',
  ...
  'dbt-industry': {
    id: 'dbt-industry',
    name: 'Minister of State (Industry)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Industry), jointly in the Department for Business, Innovation, Science and Trade and the Department of Health and Social Care.',
    currentHolder: 'Chris McDonald',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-business-and-trade--3',
    parentIds: ['pm', 'dbt-sec', 'dhsc-sec'],
  },
  'dbt-minister-state-2': {
    id: 'dbt-minister-state-2',
    name: 'Minister of State (Department for Business, Innovation, Science and Trade)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Department for Business, Innovation, Science and Trade.',
    currentHolder: 'Anas Sarwar',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--department-for-business-and-trade--2',
    parentIds: ['pm', 'dbt-sec'],
  },
  'dbt-pus-3': {
    id: 'dbt-pus-3',
    name: 'Parliamentary Under-Secretary (BIST)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Business, Innovation, Science and Trade.',
    currentHolder: 'Lord Leong',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-business-and-trade--4',
    parentIds: ['pm', 'dbt-sec'],
  },
  'dbt-pus-4': {
    id: 'dbt-pus-4',
    name: 'Parliamentary Under-Secretary (BIST and Culture)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State, jointly in the Department for Digital, Culture, Media and Sport and the Department for Business, Innovation, Science and Trade.',
    currentHolder: 'Baroness Lloyd of Effra',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-business-and-trade--5',
    parentIds: ['pm', 'dbt-sec', 'dcms-sec'],
  },
  'dsit-digital-gov': {
    id: 'dsit-digital-gov',
    ...
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State (Digital Government), covering the Government Digital Service following its move into the Department for Digital, Culture, Media and Sport.',
  ...
  'defra-water': {
    id: 'defra-water',
    name: 'Minister of State (Department for Environment, Food and Rural Affairs)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Minister of State in the Department for Environment, Food and Rural Affairs.',
  ...
  'defra-pus-2': {
    id: 'defra-pus-2',
    name: 'Parliamentary Under-Secretary (Defra)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Environment, Food and Rural Affairs.',
    currentHolder: 'Jenny Riddell-Carpenter',
  ...
  'dcms-museums': {
    id: 'dcms-museums',
    name: 'Parliamentary Secretary (Cabinet Office and DCMS)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Secretary in the Cabinet Office. Remains Parliamentary Under-Secretary of State (Museums and Heritage) in the Department for Digital, Culture, Media and Sport.',
    ...
    parentIds: ['pm', 'dcms-sec', 'cabinet-office-sec'],
  },
  'dcms-pus-2': {
    id: 'dcms-pus-2',
    name: 'Parliamentary Under-Secretary (DCMS)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Digital, Culture, Media and Sport.',
    currentHolder: 'Vicky Foxcroft',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-culture-media-and-sport--3',
    parentIds: ['pm', 'dcms-sec'],
  },
  'dcms-pus-3': {
    id: 'dcms-pus-3',
    ...
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Department for Digital, Culture, Media and Sport.',
    currentHolder: 'Ruth Mackenzie',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--department-for-culture-media-and-sport--4',
    parentIds: ['pm', 'dcms-sec'],
  },
  'ni-pus': {
    jurisdictions: ['northern-ireland'],
  ...
  'ni-pus-2': {
    ...
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Under-Secretary of State in the Northern Ireland Office.',
    currentHolder: 'Baroness Anderson of Stoke-on-Trent',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-under-secretary-of-state--northern-ireland-office--2',
    parentIds: ['pm', 'ni-sec'],
  },
  'scotland-pus': {
    jurisdictions: ['scotland'],
  ...
  'solicitor-gen': {
    ...
    currentHolder: 'Andy Slaughter',
    infoUrl: 'https://www.gov.uk/government/ministers/solicitor-general',
    parentIds: ['pm', 'attorney-gen'],
  },
  'co-minister-state': {
    id: 'co-minister-state',
    name: 'Minister of State (Minister for Artificial Intelligence)',
    category: 'official',
    subtype: 'junior-minister',
    role: 'Cabinet Member',
    description: 'Minister of State (Minister for Artificial Intelligence), jointly in the Cabinet Office and the Department for Business, Innovation, Science and Trade. Attends Cabinet.',
    currentHolder: 'Kanishka Narayan',
    infoUrl: 'https://www.gov.uk/government/ministers/minister-of-state--cabinet-office',
    parentIds: ['pm', 'cabinet-office-sec', 'dbt-sec'],
  },
  'co-pus-1': {
    id: 'co-pus-1',
    name: 'Parliamentary Secretary (Cabinet Office)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Secretary in the Cabinet Office.',
    currentHolder: 'Mark Ferguson',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-secretary-cabinet-office',
    parentIds: ['pm', 'cabinet-office-sec'],
  },
  'co-pus-2': {
    id: 'co-pus-2',
    name: 'Parliamentary Secretary (Cabinet Office and MHCLG)',
    category: 'official',
    subtype: 'junior-minister',
    description: 'Parliamentary Secretary in the Cabinet Office and Parliamentary Under-Secretary of State in the Ministry of Housing, Communities and Local Government.',
    currentHolder: 'Sally Jameson',
    infoUrl: 'https://www.gov.uk/government/ministers/parliamentary-secretary-cabinet-office--2',
    parentIds: ['pm', 'cabinet-office-sec', 'dluhc-sec'],
  },
  ...
  'dbt-perm-sec': {
    id: 'dbt-perm-sec',
    name: 'Permanent Secretary, BIST',
    category: 'official',
    subtype: 'civil-servant',
    description: 'Permanent Secretary of the Department for Business, Innovation, Science and Trade.',
  ...
  'co': {
    ...
    secondaryParentIds: ['co-minister-state', 'co-pus-1', 'co-pus-2', 'treasury-fin-sec', 'fcdo-middle-east', 'home-security', 'dcms-museums'],
  },
  'dbt': {
    jurisdictions: ['uk'],
    id: 'dbt',
    ...
    category: 'department',
    subtype: 'ministerial',
    description: 'Responsible for business, innovation, science, trade and industry policy, including support from foundational research through to scaling up innovative firms.',
    infoUrl: 'https://www.gov.uk/government/organisations/department-for-business-and-trade',
    parentIds: ['dbt-sec', 'dbt-perm-sec'],
    secondaryParentIds: ['dbt-employment-rights', 'dbt-industry', 'dbt-small-biz', 'dbt-trade', 'dbt-minister-state-2', 'dbt-pus-3', 'dbt-pus-4'],
    tags: ['sector-business', 'sector-finance', 'sector-science'],
  },
  'dcms': {
    jurisdictions: ['uk'],
    id: 'dcms',
    ...
    category: 'department',
    subtype: 'ministerial',
    description: 'Manages digital, telecoms, media, online safety, cultural policy, sport, and tourism, including the Government Digital Service.',
    infoUrl: 'https://www.gov.uk/government/organisations/department-for-culture-media-and-sport',
    parentIds: ['dcms-sec', 'dcms-perm-sec'],
    secondaryParentIds: ['dcms-creative', 'dcms-museums', 'dcms-sport', 'dcms-pus-2', 'dcms-pus-3', 'dbt-pus-4', 'dsit-digital-gov'],
  ...
  'defra': {
    ...
    secondaryParentIds: ['defra-biosecurity', 'defra-water', 'defra-pus-2', 'defra-pus-3'],
  ...
  'desnz': {
    ...
    secondaryParentIds: ['desnz-climate', 'desnz-consumers', 'desnz-energy', 'desnz-pus-3', 'desnz-pus-4'],
  ...
  'dfe': {
    ...
    secondaryParentIds: ['dfe-children', 'dfe-schools', 'dfe-skills', 'dfe-pus-2'],
  ...
  'dhsc': {
    ...
    secondaryParentIds: ['dhsc-care', 'dhsc-innovation', 'dhsc-secondary-care', 'dhsc-womens-health', 'dhsc-minister-state-3', 'dhsc-minister-state-4', 'dhsc-minister-state-5', 'dhsc-pus-2'],
    tags: ['sector-health'],
  },
  'dluhc': {
    jurisdictions: ['england'],
    ...
    secondaryParentIds: ['dluhc-housing', 'dluhc-local-gov-2', 'dluhc-equalities', 'dluhc-pus-3', 'dluhc-pus-4', 'dluhc-pus-5', 'dluhc-equalities-2', 'co-pus-2'],
  ...
  'dwp': {
    ...
    secondaryParentIds: ['dwp-employment', 'dwp-pensions', 'dwp-minister-state-2', 'dwp-pus-2', 'dluhc-equalities', 'dfe-skills'],
    tags: ['sector-welfare'],
  },
  'fcdo': {
    ...
    secondaryParentIds: ['fcdo-europe', 'fcdo-middle-east', 'fcdo-multilateral', 'fcdo-pus-1', 'fcdo-pus-2', 'fcdo-pus-3', 'fcdo-minister-state-2'],
  ...
  'home-office': {
    ...
    secondaryParentIds: ['home-migration', 'home-policing', 'home-safeguarding', 'home-security', 'home-minister-state-2', 'home-pus-2', 'home-equalities-pus-1', 'home-equalities-pus-2'],
  ...
  'mod': {
    ...
    secondaryParentIds: ['mod-armed-forces', 'mod-readiness', 'mod-veterans', 'mod-minister-state-2', 'mod-pus-2'],
    tags: ['sector-defence'],
  },
  'moj': {
    jurisdictions: ['england-wales'],
    ...
    secondaryParentIds: ['moj-courts', 'moj-sentencing', 'moj-victims', 'moj-minister-state-2', 'moj-pus-2'],
  ...
  'ni-office': {
    ...
    secondaryParentIds: ['ni-pus', 'ni-pus-2'],
  },
  'pm-office': {
    jurisdictions: ['uk'],
    id: 'pm-office',
  ...
  'treasury': {
    ...
    secondaryParentIds: ['treasury-chief-sec', 'treasury-econ-sec', 'treasury-exchequer-sec', 'treasury-fin-sec', 'treasury-pus-1', 'dwp-pensions'],
    tags: ['sector-finance'],
  },
  'ukef': {
    jurisdictions: ['uk'],
  ...
  'charity-comm': {
    ...
    description: 'Statutory regulator of charities in England and Wales; registers charities, investigates misconduct, and ensures trustees comply with their legal obligations.',
    infoUrl: 'https://www.gov.uk/government/organisations/charity-commission',
    parentIds: ['dcms', 'charity-comm-ceo', 'charity-comm-chair'],
    tags: ['statutory-regulator', 'sector-charities'],
  },
  'cma': {
    jurisdictions: ['uk'],
    id: 'cma',
    ...
    category: 'department',
    subtype: 'non-ministerial',
    description: 'Statutory regulator that promotes competition across the UK economy; investigates mergers and markets, tackles anti-competitive behaviour, and enforces consumer protection law.',
  ...
  'forestry-commission': {
    ...
    tags: ['statutory-regulator', 'sector-environment'],
  },
  'fsa': {
    ...
    tags: ['statutory-regulator', 'sector-food-farming', 'sector-health'],
  },
  'gad': {
    jurisdictions: ['uk'],
    id: 'gad',
  ...
  'ofgem': {
    ...
    category: 'department',
    subtype: 'non-ministerial',
    description: 'Statutory regulator for gas and electricity markets in Great Britain; protects consumer interests, enforces market rules, and promotes competition and sustainability in the energy sector.',
  ...
  'ofsted': {
    ...
    category: 'department',
    subtype: 'non-ministerial',
    description: 'Inspects and regulates education, children\'s services and skills in England, reporting publicly on quality and standards.',
    infoUrl: 'https://www.gov.uk/government/organisations/ofsted',
    parentIds: ['dfe', 'ofsted-hmci', 'ofsted-chair'],
    tags: ['statutory-regulator', 'inspector', 'sector-education'],
  },
  'ofwat': {
    jurisdictions: ['england-wales'],
    id: 'ofwat',
    ...
    category: 'department',
    subtype: 'non-ministerial',
    description: 'Statutory economic regulator for water and sewerage services in England and Wales; sets price controls, monitors company performance, and protects consumer and environmental interests.',
  ...
  'orr': {
    ...
    category: 'department',
    subtype: 'non-ministerial',
    description: 'Statutory economic and safety regulator for railways in Great Britain and monitor of Highways England; sets Network Rail\'s efficiency targets and enforces safety standards across the rail network.',
  ...
  'companies-house': {
    ...
    parentIds: ['dbt'],
    tags: ['statutory-regulator', 'sector-business'],
  },
  'des': {
    jurisdictions: ['uk', 'overseas-territories'],
    id: 'des',
  ...
  'dvla': {
    ...
    category: 'department',
    subtype: 'agency',
    description: 'Manages vehicle registration, licensing, and driving licences for Great Britain; holds the national register of drivers and vehicles.',
  ...
  'ipo': {
    ...
    parentIds: ['dbt'],
    tags: ['statutory-regulator', 'sector-business', 'sector-digital'],
  },
  'legal-aid': {
    jurisdictions: ['england-wales'],
    id: 'legal-aid',
  ...
  'vmd': {
    ...
    category: 'department',
    subtype: 'agency',
    description: 'Statutory regulator for veterinary medicines in the UK; authorises products, monitors safety and efficacy, enforces medicines legislation, and publishes the Veterinary Medicines Regulations.',
    infoUrl: 'https://www.gov.uk/government/organisations/veterinary-medicines-directorate',
    parentIds: ['defra'],
    tags: ['statutory-regulator', 'sector-food-farming'],
  },
  'voa': {
    jurisdictions: ['england-wales'],
    id: 'voa',
  ...
  'bank-of-england': {
    ...
    parentIds: ['treasury'],
    tags: ['statutory-regulator', 'sector-finance'],
  },
  'bfi': {
    jurisdictions: ['uk'],
    id: 'bfi',
  ...
  'cqc': {
    ...
    parentIds: ['dhsc'],
    tags: ['statutory-regulator', 'inspector', 'sector-health'],
  },
  'csc-uk': {
    jurisdictions: ['uk'],
    id: 'csc-uk',
  ...
  'dbs': {
    ...
    parentIds: ['home-office'],
    tags: ['statutory-regulator', 'sector-justice', 'sector-education'],
  },
  'east-west-railway': {
    jurisdictions: ['england'],
  ...
  'ehrc': {
    ...
    parentIds: ['co'],
    tags: ['statutory-regulator', 'adviser'],
  },
  'environment-agency': {
    jurisdictions: ['england'],
    ...
    category: 'body',
    subtype: 'executive-ndpb',
    description: 'Statutory regulator for the environment in England; regulates major industries, waste, water quality, and flood risk; enforces environmental law and responds to pollution incidents.',
  ...
  'dwi': {
    ...
    category: 'department',
    subtype: 'division-directorate',
    description: 'Statutory regulator that assesses the quality and safety of public drinking water supplies in England and Wales, carries out independent inspections of water companies, and reports to the Secretary of State.',
    infoUrl: 'https://www.gov.uk/government/organisations/drinking-water-inspectorate',
    parentIds: ['defra'],
    tags: ['statutory-regulator', 'sector-environment'],
  },
  'frc': {
  ...
  'gambling-commission': {
    ...
    parentIds: ['dcms'],
    tags: ['statutory-regulator', 'sector-gambling'],
  },
  'bbfc': {
    jurisdictions: ['uk'],
    id: 'bbfc',
    ...
    category: 'body',
    subtype: 'other',
    description: 'Statutory regulator for film and video works in the UK; classifies films, DVDs, and on-demand content by age rating (U, PG, 12A, 15, 18) to protect audiences from harmful or unsuitable material.',
    infoUrl: 'https://www.bbfc.co.uk/',
    parentIds: ['dcms'],
    tags: ['statutory-regulator', 'sector-culture', 'sector-media'],
  },
  'gb-china-centre': {
    jurisdictions: ['uk'],
    id: 'gb-china-centre',
  ...
  'glaa': {
    ...
    parentIds: ['home-office'],
    tags: ['statutory-regulator', 'sector-business', 'sector-immigration'],
  },
  'hblb': {
    jurisdictions: ['gb'],
    id: 'hblb',
  ...
  'hfea': {
    ...
    parentIds: ['dhsc'],
    tags: ['statutory-regulator', 'sector-health', 'sector-science'],
  },
  'historic-england': {
    jurisdictions: ['england'],
    id: 'historic-england',
    ...
    parentIds: ['dcms'],
    tags: ['statutory-regulator', 'adviser', 'sector-culture', 'sector-planning'],
  },
  'homes-england': {
    jurisdictions: ['england'],
    id: 'homes-england',
  ...
  'ico': {
    ...
    parentIds: ['dbt'],
    tags: ['statutory-regulator', 'sector-digital'],
  },
  'icrir': {
    jurisdictions: ['northern-ireland'],
    id: 'icrir',
  ...
  'ifr': {
    ...
    category: 'body',
    subtype: 'executive-ndpb',
    description: 'Statutory regulator for English football; oversees the financial sustainability, fan engagement, and governance of football clubs in the top five tiers of the professional game.',
    infoUrl: 'https://www.gov.uk/government/organisations/independent-football-regulator',
    parentIds: ['dcms'],
    tags: ['statutory-regulator', 'sector-culture'],
  },
  'ima': {
    jurisdictions: ['uk'],
    id: 'ima',
    ...
    parentIds: ['co'],
    tags: ['statutory-regulator', 'sector-immigration'],
  },
  'immigration-advice-auth': {
    ...
    parentIds: ['home-office'],
    tags: ['statutory-regulator', 'sector-immigration', 'sector-legal'],
  },
  'iopc': {
    jurisdictions: ['england-wales'],
    id: 'iopc',
    ...
    category: 'body',
    subtype: 'executive-ndpb',
    description: 'Oversees the police complaints system in England and Wales; investigates the most serious matters involving the police, including deaths following police contact.',
    infoUrl: 'https://www.gov.uk/government/organisations/independent-office-for-police-conduct',
    parentIds: ['home-office'],
    tags: ['statutory-regulator', 'inspector', 'police', 'sector-justice'],
  },
  'iwm': {
    jurisdictions: ['uk'],
    id: 'iwm',
  ...
  'lsb': {
    ...
    parentIds: ['moj'],
    tags: ['statutory-regulator', 'sector-legal'],
  },
  'macc': {
    jurisdictions: ['uk'],
    id: 'macc',
  ...
  'mining-rem-auth': {
    ...
    category: 'body',
    subtype: 'executive-ndpb',
    description: 'Manages and remediates the environmental legacy of coal mining across Great Britain; regulates coal mine water discharge and subsidence damage; formerly the Coal Authority.',
    infoUrl: 'https://www.gov.uk/government/organisations/coal-authority',
    parentIds: ['desnz'],
    tags: ['statutory-regulator', 'sector-environment', 'sector-energy'],
  },
  'mmo': {
    jurisdictions: ['england'],
    id: 'mmo',
    ...
    parentIds: ['defra'],
    tags: ['statutory-regulator', 'sector-environment', 'sector-food-farming'],
  },
  'museum-home': {
    jurisdictions: ['england'],
    id: 'museum-home',
  ...
  'natural-england': {
    ...
    category: 'body',
    subtype: 'executive-ndpb',
    description: 'Statutory regulator and adviser for the natural environment in England; designates protected areas, regulates species and habitats, and advises on planning and development affecting nature.',
    infoUrl: 'https://www.gov.uk/government/organisations/natural-england',
    parentIds: ['defra'],
    tags: ['statutory-regulator', 'adviser', 'sector-environment'],
  },
  'nda': {
    jurisdictions: ['gb'],
    id: 'nda',
  ...
  'nice': {
    ...
    category: 'body',
    subtype: 'executive-ndpb',
    description: 'Produces evidence-based guidance and quality standards for health and social care, and approves medicines and treatments for use in England.',
    infoUrl: 'https://www.gov.uk/government/organisations/national-institute-for-health-and-care-excellence',
    parentIds: ['dhsc'],
    tags: ['statutory-regulator', 'adviser', 'nhs-body', 'sector-health'],
  },
  'nihe': {
    jurisdictions: ['northern-ireland'],
    id: 'nihe',
  ...
  'oep': {
    ...
    parentIds: ['defra'],
    tags: ['statutory-regulator', 'inspector', 'sector-environment'],
  },
  'ofcom': {
    jurisdictions: ['uk'],
    id: 'ofcom',
    ...
    parentIds: ['dcms'],
    tags: ['statutory-regulator', 'sector-media', 'sector-digital', 'sector-communications'],
  },
  'ofstu': {
    jurisdictions: ['england'],
    id: 'ofstu',
    ...
    category: 'body',
    subtype: 'executive-ndpb',
    description: 'Regulates the higher education sector in England, registering providers, setting quality standards, and protecting the interests of students.',
  ...
  'rsh': {
    ...
    parentIds: ['dluhc'],
    tags: ['statutory-regulator', 'sector-housing'],
  },
  'salix': {
    jurisdictions: ['england'],
    id: 'salix',
  ...
  'ssro': {
    ...
    parentIds: ['mod'],
    tags: ['statutory-regulator', 'sector-defence', 'sector-finance'],
  },
  'tate': {
    jurisdictions: ['uk'],
    id: 'tate',
  ...
  'trinity-house': {
    jurisdictions: ['england-wales', 'crown-dependencies', 'overseas-territories'],
    id: 'trinity-house',
    name: 'Trinity House',
    category: 'body',
    subtype: 'executive-ndpb',
  ...
  'steac': {
    ...
    category: 'body',
    subtype: 'advisory-ndpb',
    description: 'Advises BIST on ethical issues arising from emerging science and technology.',
  ...
  'govt-recruitment-service': {
    ...
    parentIds: ['onegov-delivery-agency'],
    tags: ['high-profile-group'],
  },
  ...
  'public-sector-fraud-authority': {
    ...
    category: 'department',
    subtype: 'division-directorate',
    description: 'Works with departments and public bodies to understand and reduce the impact of fraud on the public sector. Transferred to the Department for Work and Pensions, with continued sponsorship from HM Treasury.',
    infoUrl: 'https://www.gov.uk/government/organisations/public-sector-fraud-authority',
    parentIds: ['dwp'],
    secondaryParentIds: ['chancellor'],
  ...
  'office-impact-economy': {
    jurisdictions: ['uk'],
    id: 'office-impact-economy',
    name: 'Office for the Impact Economy',
    category: 'department',
    subtype: 'division-directorate',
    description: 'Leads policy on the impact economy and digital identity, moved from the Cabinet Office to the Department for Digital, Culture, Media and Sport.',
    infoUrl: 'https://www.gov.uk/government/organisations/cabinet-office',
    parentIds: ['dcms'],
    tags: ['high-profile-group', 'sector-digital'],
  },
  'investment-security-unit': {
    jurisdictions: ['uk'],
    id: 'investment-security-unit',
    name: 'Investment Security Unit',
    category: 'department',
    subtype: 'division-directorate',
    description: 'Screens investments and acquisitions for national security risks under the National Security and Investment Act. Moved from the Cabinet Office to the Department for Business, Innovation, Science and Trade.',
    infoUrl: 'https://www.gov.uk/government/organisations/investment-security-unit',
    parentIds: ['dbt'],
    tags: ['high-profile-group', 'sector-security', 'sector-business'],
  },
  ...
  'defence-safety-authority': {
    ...
    parentIds: ['mod'],
    tags: ['high-profile-group', 'statutory-regulator', 'armed-forces', 'sector-defence'],
  },
  ...
  'military-aviation-authority': {
    ...
    parentIds: ['mod'],
    tags: ['high-profile-group', 'statutory-regulator', 'armed-forces', 'sector-defence', 'sector-transport'],
  },
  ...
  'offshore-petroleum-regulator': {
    ...
    parentIds: ['desnz'],
    tags: ['high-profile-group', 'statutory-regulator', 'sector-energy', 'sector-environment'],
  },
  ...
  'employment-agency-standards': {
    ...
    parentIds: ['dbt'],
    tags: ['high-profile-group', 'statutory-regulator', 'sector-business'],
  },
  ...
  'export-control-joint-unit': {
    ...
    parentIds: ['dbt'],
    tags: ['high-profile-group', 'statutory-regulator', 'sector-business', 'sector-international', 'sector-defence'],
  },
  ...
  'office-trade-sanctions': {
    ...
    parentIds: ['dbt'],
    tags: ['high-profile-group', 'statutory-regulator', 'sector-business', 'sector-international'],
  },
  ...
  'no10-north': {
    ...
    category: 'department',
    subtype: 'division-directorate',
    description: 'The engine room of devolution and good growth in every postcode, bringing together local economic growth and devolution strategy from MHCLG and local economic growth policy from HM Treasury.',
    infoUrl: 'https://www.gov.uk/government/organisations/prime-ministers-office-10-downing-street',
    parentIds: ['opmc'],
    tags: ['high-profile-group'],
  },
  'opmc': {
    jurisdictions: ['uk'],
    id: 'opmc',
    name: 'Office for the Prime Minister and Cabinet',
    category: 'department',
    subtype: 'division-directorate',
    description: 'Houses No.10, No.10 North and core Cabinet Office functions serving the Prime Minister and Cabinet, focusing the centre of government on delivering the Government\'s top strategic priorities.',
    infoUrl: 'https://www.gov.uk/government/organisations/prime-ministers-office-10-downing-street',
    parentIds: ['pm', 'cabinet-office-sec'],
    tags: ['high-profile-group'],
  },
  'ai-taskforce': {
    ...
    category: 'department',
    subtype: 'division-directorate',
    description: 'Drives the Government\'s overall strategy on AI and unlocks the opportunities it holds for growth, prosperity and public sector transformation. Includes the AI Security Institute.',
    infoUrl: 'https://www.gov.uk/government/organisations/cabinet-office',
    parentIds: ['opmc'],
    tags: ['high-profile-group', 'sector-digital', 'sector-science'],
  },
  'onegov-delivery-agency': {
    jurisdictions: ['uk'],
    id: 'onegov-delivery-agency',
    name: 'OneGov Delivery Agency',
    category: 'department',
    subtype: 'agency',
    description: 'Manages operational services at arm\'s length within the Cabinet Office family, including the Government Recruitment Service, pensions, shared services, the Government Car Service, and security vetting.',
    infoUrl: 'https://www.gov.uk/government/organisations/cabinet-office',
    parentIds: ['co'],
    tags: ['high-profile-group'],
  },
  ...
  'nmc': {
    ...
    parentIds: ['dhsc'],
    tags: ['professional-regulator', 'sector-health'],
  },
  ...
  'office-equality-opportunity': {
    ...
    category: 'body',
    subtype: 'other',
    description: 'Leads cross-government work on equality, diversity, and reducing disparities. Moved from the Cabinet Office to the Ministry of Housing, Communities and Local Government.',
  ...
  'groceries-adjudicator': {
    ...
    category: 'body',
    subtype: 'other',
    description: 'Statutory regulator that ensures large supermarkets treat their direct suppliers lawfully and fairly under the Groceries Supply Code of Practice; can investigate, arbitrate, and fine retailers.',
    infoUrl: 'https://www.gov.uk/government/organisations/groceries-code-adjudicator',
    parentIds: ['dbt'],
    tags: ['statutory-regulator', 'sector-business', 'sector-food-farming'],
  },
  'cic-regulator': {
    jurisdictions: ['uk'],
    id: 'cic-regulator',
    ...
    category: 'body',
    subtype: 'other',
    description: 'Regulates community interest companies, ensuring they operate for the benefit of the community; approves CIC applications and investigates complaints.',
  ...
  'pubs-adjudicator': {
    ...
    category: 'body',
    subtype: 'other',
    description: 'Statutory regulator that oversees the Pubs Code, arbitrates disputes between tied pub tenants and large pub-owning businesses, and investigates potential breaches of the Code.',
  ...
  // ── Former DSIT additions (now BIST) ──────────────────────────────────────
  'npl': {
    jurisdictions: ['uk'],
    id: 'npl',
  ...
  'ipco-commissioner': {
    id: 'ipco-commissioner',
    name: 'Investigatory Powers Commissioner',
    currentHolder: 'Sir Brian Leveson',
    category: 'official',
    subtype: 'independent',
    description: 'Heads the Investigatory Powers Commissioner\'s Office and leads the Judicial Commissioners in providing independent oversight of investigatory powers warrants. Appointed by the Prime Minister under the Investigatory Powers Act 2016 s.227.',
    infoUrl: 'https://www.gov.uk/government/organisations/investigatory-powers-commissioners-office/about/our-governance',
    parentIds: [],
  },
  'ipco': {
    jurisdictions: ['uk'],
    ...
    category: 'body',
    subtype: 'other',
    description: 'Provides independent judicial oversight of the use of investigatory powers — including surveillance warrants and equipment interference — by intelligence agencies, law enforcement, and other public authorities. Headed by the Investigatory Powers Commissioner, appointed by the Prime Minister under the Investigatory Powers Act 2016.',
    infoUrl: 'https://www.gov.uk/government/organisations/investigatory-powers-commissioners-office',
    parentIds: ['ipco-commissioner', 'home-office'],
    tags: ['inspector', 'sector-security', 'sector-legal'],
  },
  'nctso': {
    jurisdictions: ['uk'],
    id: 'nctso',
  ...
  'forensic-science-regulator': {
    ...
    category: 'body',
    subtype: 'other',
    description: 'Sets and monitors quality standards for forensic science providers in England and Wales, with statutory powers to issue codes of practice.',
    infoUrl: 'https://www.gov.uk/government/organisations/forensic-science-regulator',
    parentIds: ['home-office'],
    tags: ['statutory-regulator', 'sector-security', 'sector-legal'],
  },
  'hmicfrs': {
    jurisdictions: ['england-wales'],
    id: 'hmicfrs',
  ...
  'ipsa': {
    ...
    category: 'body',
    subtype: 'other',
    description: 'Independently regulates and administers MPs\' business costs, staffing expenditure, and pay; established by the Parliamentary Standards Act 2009.',
  ...
  'electoral-commission': {
    ...
    category: 'body',
    subtype: 'other',
    description: 'Statutory regulator for elections and political finance in the UK; registers political parties and campaign groups, sets donation and spending rules, and reports on electoral integrity.',
  ...
  'cag': {
    ...
    currentHolder: 'Gareth Davies',
    category: 'official',
    subtype: 'independent',
    description: 'Officer of the House of Commons responsible for auditing central government accounts and scrutinising the economy, efficiency, and effectiveness of public spending. Appointed by the Crown on an address from the House of Commons. Heads the National Audit Office and reports to Parliament, not to ministers.',
    infoUrl: 'https://www.gov.uk/government/organisations/national-audit-office/about/our-governance',
    parentIds: [],
  },
  'nao': {
    jurisdictions: ['uk'],
    ...
    category: 'body',
    subtype: 'other',
    description: 'Independent parliamentary body that audits central government departments, agencies, and public bodies. Supports the Comptroller and Auditor General in scrutinising public spending for Parliament.',
